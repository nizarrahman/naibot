...
<head>
    ...
    <title>NaiBot</title>
    <meta name="description" content="Binggung Cari Bot? Ya Disini Aja. NaiBot Hadir Untuk Membantu Anda">
                ...
                <div id="navbarBasicExample" class="navbar-menu">
                    ...
                    <div class="navbar-end">
                        <div class="navbar-item">
                            <div class="buttons">
                                <a class="button is-link has-text-white has-text-weight-bold" href="https://wa.me/?text=*Link NaiBot :*%0A<?= "https://" . $_SERVER['HTTP_HOST']  . $_SERVER['PHP_SELF']; ?>" title="Berbagi">
            ...
            <div class="my-auto">
                <div class="column is-6 mx-auto has-text-centered">
                    <h1 class="title" style="font-size:4rem;padding:0 5rem;">
                        Maaf Kak, Harus Buka Dari Laptop Atau Pc Anda!
                    </h1>
                </div>
            </div>
        </section>
